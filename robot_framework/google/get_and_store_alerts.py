...
def get_alerts_past_week(oc_conn: OrchestratorConnection) -> List[Dict[str, Any]]:
    ...
    """
    p12_key_path = oc_conn.get_constant("google_dlp_p12").value
    scopes = ['https://www.googleapis.com/auth/apps.alerts']
    app_email = oc_conn.get_constant("google_dlp_app_email").value
    admin_email = oc_conn.get_constant("google_dlp_admin_email").value
